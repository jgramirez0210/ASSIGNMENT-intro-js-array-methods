...
const search = (event) => {
  ...
  constsearchResult = referenceList.filter(taco => {
    tacotitle.toLowerCase().includes(eventLC) ||
    tacoauthor.toLowerCase().includes(eventLC) ||
    tacodescription.toLowerCase().includes(eventLC)
  }) 
